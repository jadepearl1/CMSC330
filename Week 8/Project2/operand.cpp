...
/* Jade Pearl modified this file. Last modified on 10/10/2023. Edited the parse function to change
value from type int to double which enables the program to allow unsigned floating numbers in the input */
